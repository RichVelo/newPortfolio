...
<body class="">
    ...
    <main>
            ...
            <div class="about-me">
                ...
                <div class="statement">
                    <p> I'm a Junior Full Stack Developer and certified Scrum Master, seeking my first
                        ...
                        I graduated in May 2022 from the Full Stack Track at <span class="full-stack"><a href="https://io-academy.uk/courses/full-stack-track/" target="_blank">iO Academy</a></span>
        ...
        <section class="timelineIntoTech">
            <h2>Timeline into Tech</h2>
            <div class="timeline">
                <ul>
                    <li>
                        <div class="content">
                    ...
                    <li>
                        <div class="content">
                            <h3>Left FOS</h3>
                            <p> I left the Financial Ombudsman Service on this date to begin my journey into tech.</p>
                        </div>
                        <div class="time">
                            <h4>30 November 2021</h4>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="content">
                            <h3>The Job Hunt</h3>
                            <p>From the end of May 2022 to the present day I have been applying and interviewing for my first dev role. It's taking a little longer than I hoped but I have time to also learn more and improve my skills and portfolio. I am so much happier having undertaken this monumental life change and just have not looked back.</p>
                        </div>
                        <div class="time">
                            <h4>Present</h4>
                        </div>
        ...
        <div class="footer-right">
            <div class="footer-links">
                ...
                <div class="socials">
                    ...
                    <a href="https://www.linkedin.com/in/richjkerr" class="fa fa-linkedin" target="__blank"></a>
                </div>
